...
1.  **Download the latest package:**
    ```bash
    wget [https://github.com/YourRepo/releases/download/v1.37/super-pxe-server_1.37_amd64.deb](https://github.com/YourRepo/releases/download/v1.37/super-pxe-server_1.37_amd64.deb)
    ```
